...
const allureTasks = (opts) => {
    ...
    let allureReporter = new allure_reporter_plugin_1.AllureReporter(opts, taskManager);
    ...
    return {
        ...
        specStarted: (arg) => {
            ...
            allureReporter = new allure_reporter_plugin_1.AllureReporter(opts, taskManager);
        ...
        writeEnvironmentInfo(arg) {
            try {
                if (!(0, fs_1.existsSync)(allureResults)) {
                    (0, fs_1.mkdirSync)(allureResults);
                }
        ...
        afterSpec(arg) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (arg.results && ((_a = arg.results) === null || _a === void 0 ? void 0 : _a.video)) {
                    ...
                    allureReporter.attachVideoToContainers({ path: video !== null && video !== void 0 ? video : '' });
                }
                else {
                ...
                taskManager.flushAllTasksForQueue(arg.results.spec.relative).then(() => {
                    var _a, _b;
                    (0, common_1.logWithPackage)('log', `Finished processing all files for spec ${(_b = (_a = arg.results) === null || _a === void 0 ? void 0 : _a.spec) === null || _b === void 0 ? void 0 : _b.relative}`);
                });
                log('afterSpec');
            });
        },
